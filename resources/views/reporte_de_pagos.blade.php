...
<main class="p-6 min-h-[calc(100%-160px)]">
    <div class="px-5 pb-5 bg-gray-100 dark:bg-gray-900 rounded-xl shadow-[0_0px_20px_0px_rgba(0,0,0,0.2)]">
        ...
        <div class="flex justify-between items-center gap-4 flex-col md:flex-row flex-wrap m-5 mt-0">
        ...
        <div class="flex justify-start md:items-end gap-x-14 gap-y-4 flex-col md:flex-row flex-wrap m-5 mt-0">
        ...
        <div class="overflow-x-auto m-5 mt-0" id="DivReporteDePagos">
