...
<main class="w-[calc(100%-3.73rem)] ml-auto h-[calc(100%-72px)]">
    <div class="2xl:container mx-auto">
        <div class="h-16 border-b border-gray-300/40 dark:border-gray-700 flex items-center">
            <h3 class="text-gray-700 dark:text-gray-300 font-semibold ml-[calc(3.73rem)]" id="mensaje_bienvenida">Buenas dias</h3>
            <span class="text-gray-700 dark:text-gray-300 font-semibold">&nbsp;Balinsa</span>
        </div>
