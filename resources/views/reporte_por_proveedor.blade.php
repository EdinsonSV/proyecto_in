...
<div class="fixed inset-0 overflow-hidden z-[100] hidden" id="ModalRegistrarGuias">
...
<div class="fixed inset-0 overflow-hidden z-[100] hidden" id="ModalRegistrarGuiasEditar">
    <div class="flex justify-center items-center w-full min-h-screen h-full py-4 px-4 text-center">
        <!-- Fondo oscuro overlay -->
        <div class="fixed inset-0 transition-opacity" aria-hidden="true">
            <div class="absolute inset-0 bg-gray-900 opacity-75"></div>
