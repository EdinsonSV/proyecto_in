...
<body>
    <section class="min-h-screen bg-gray-50 dark:bg-gray-800" x-data="{ sideBar: false }">
        <nav class="border-r border-gray-300 dark:border-gray-700 fixed top-0 left-0 z-20 h-full overflow-x-hidden overflow-y-auto transition origin-left transform bg-gray-50 dark:bg-gray-900 w-60 md:translate-x-0" :class="{ '-translate-x-full' : !sideBar, 'translate-x-0' : sideBar }" @click.away="sideBar = false"> 
        ...
        <div class="ml-0 transition md:ml-60">
            <header class="flex items-center justify-between w-full px-4 h-20 border-b border-gray-300 dark:border-gray-700"> 
