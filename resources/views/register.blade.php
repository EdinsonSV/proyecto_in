...
<main class="w-[calc(100%-3.73rem)] ml-auto h-[calc(100%-72px)]">
    <div class="2xl:container mx-auto">
        <div class="h-16 border-b border-gray-300/40 dark:border-gray-700 flex items-center">
            <h3 class="text-gray-700 uppercase dark:text-gray-300 font-semibold ml-[calc(3.73rem)]" id="mensaje_bienvenida">Buenos dias</h3>
        ...
        <div class="px-6 lg:px-12 mt-[calc(1.865rem)] overflow-x-auto">
            <div class="flex-col rounded-lg border border-gray-300/40 dark:border-gray-700 shadow-lg shadow-slate-200 dark:shadow-slate-800 ">
                ...
                <form action="/register" method="POST" class="p-5 pt-0 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4">
                    @csrf
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="apellidoPaternoUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Apellido Paterno</label>
                        <input class="w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="apellidoPaternoUsu" autocomplete="off" id="apellidoMaternoUsu">
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="apellidoMaternoUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Apellido Materno</label>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="nombresUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Nombres</label>
                        <input class="w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="nombresUsu" autocomplete="off" id="nombresUsu">
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="dniUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">DNI</label>
                        <input class="w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="dniUsu" autocomplete="off" id="dniUsu">
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="celularUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Celular</label>
                        <input class="w-full uppercase outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="celularUsu" autocomplete="off" id="celularUsu">
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="direccionUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Direccion</label>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="direccionUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Tipo de Usuario</label>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="sexoUsu" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Sexo</label>
                        <div class="w-full flex gap-4 items-center justify-center flex-wrap md:flex-nowrap">
                            ...
                            <label class="w-full text-center cursor-pointer uppercase p-2.5 text-gray-900 dark:text-gray-300 border bg-sky-600" for="sexoUsuM" id="sexoUsuMR">Masculino</label>
    
                            <input class="uppercase hidden outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="radio" name="sexoUsu" value="F" id="sexoUsuF">
                            <label class="w-full text-center cursor-pointer uppercase p-2.5 text-gray-900 dark:text-gray-300 border" for="sexoUsuF" id="sexoUsuFR">Femenino</label>
                        </div>
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="email" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Correo Electronico</label>
                    ...
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="username" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Nombre de Usuario</label>
                        <input class="w-full outline-none bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" name="username" autocomplete="off" id="username">
                    </div>
                    <div class="flex flex-col md:flex-row gap-4 items-center">
                        <label for="password" class="mb-2 text-sm font-medium text-gray-900 dark:text-white w-24">Contraseña</label>
