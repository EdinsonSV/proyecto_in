        ...
        <div class="overflow-x-auto m-5 mt-0 relative" id="DivReportePorCliente">
            <div class="flex flex-col gap-5">
                ...
                <div class="flex gap-2 justify-between w-full flex-col md:flex-row">
                    <button class="text-base py-2 px-5 bg-blue-500 text-gray-50 rounded-lg" id="btnBuscarReportePorCliente"><i class='bx bx-search-alt'></i> Buscar</button>
                    <button class="text-base py-2 px-5 bg-blue-500 text-gray-50 rounded-lg" id="btnExportarExcelReportePorCliente"><i class="fa-regular fa-file-excel"></i> Exportar a Excel</button>
                </div>
            </div>
        </div>
        {{-- Tabla --}}
        <div class="relative overflow-auto rounded-lg mx-5 max-h-[500px] aside_scrollED">
            <table class="border-collapse w-full text-gray-500 dark:text-gray-400 select-none relative" id="tablaReportePorCliente">
                <thead id="headerReportePorCliente" class="bg-blue-500 text-gray-50 sticky top-0">
                    <tr class="h-10">
                        <th class="hidden">Id</th>
                        <th class="px-4 font-medium text-sm">DIA</th>
                        <th class="px-4 font-medium text-sm"><h5 class="min-w-max">HORA</h5></th>
                        <th class="px-4 font-medium text-sm"><h5 class="min-w-max">PRESENTACIÓN</h5></th>
                        <th class="px-4 font-medium text-sm"><h5 class="min-w-max">CANTIDAD</h5></th>
                        <th class="px-4 font-medium text-sm"><h5 class="min-w-max">PESO REGISTRADO (Kg.)</h5></th>
                        <th class="px-4 font-medium text-sm"><h5 class="min-w-max">PROMEDIO</h5></th>
                    </tr>
                </thead>
