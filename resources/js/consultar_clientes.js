            ...
            success: function (response) {
                ...
                if (Array.isArray(response)) {
                    ...
                    response.forEach(function (obj) {
                        ...
                        nuevaFila.append($('<td class="border-r dark:border-gray-700 p-2 text-center">').append($('<h5 class="!max-w-[100px] px-2 overflow-hidden whitespace-nowrap text-ellipsis">').text(obj.nombreTipoDocumento)));
                        ...
                        nuevaFila.append($('<td class="border-r dark:border-gray-700 p-2 text-center">').append($('<h5 class="min-w-max px-2">').text(obj.direccionCli)));
                        nuevaFila.append($('<td class="border-r dark:border-gray-700 p-2 text-center">').append($('<h5 class="min-w-max px-2">').text(obj.nombreZon)));
