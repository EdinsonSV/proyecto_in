...
class SubmenusTableSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('tb_submenus')->insert([
            ...
            ['idSubMenu' => 16, 'idMenu' => 1, 'nombreSubMenu' => 'Pedidos', 'idNombreSubMenu' => '#', 'hrefSubMenu' => '/pedidos', 'iconHtml' => 'bx bx-list-plus', 'estadoSubMenu' => 1],
            ...
            ['idSubMenu' => 18, 'idMenu' => 2, 'nombreSubMenu' => 'Seguimiento Pedidos', 'idNombreSubMenu' => '#', 'hrefSubMenu' => '/seguimiento_pedidos', 'iconHtml' => 'bx bx-stats', 'estadoSubMenu' => 1],
        ]);
    }
}
